...
from src.rag.rulebook.rulebook_assignments import (
...
def get_categories_for_section(section_id: str, title: str, level: int, all_headers: List[Tuple[str, int, str]] = None, current_index: int = None) -> List[int]:
    ...
    # 9. Parent inheritance: always inherit categories from nearest categorized parent
    if all_headers and current_index is not None:
